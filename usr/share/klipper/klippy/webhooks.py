...
class GCodeHelper:
    def __init__(self, printer):
        ...
        wh.register_endpoint("gcode/fast_script", self._handle_fast_script)
    ...
    def _handle_fast_script(self, web_request):
        self.gcode.run_script_from_command(web_request.get_str('script'))
